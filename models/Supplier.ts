...
export const COLLECTION_NAME = 'pos_suppliers';

export async function getSuppliersCollection(): Promise<Collection<Supplier>> {
    return getCollection<Supplier>(COLLECTION_NAME);
}

let indexesCreated = false;
export async function initializeSuppliersCollection() {
    ...
    try {
        ...
        console.error('Error creating suppliers indexes:', error);
    }
}
